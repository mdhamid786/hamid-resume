  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="  w-full text-justify md:text-sm"><symbol id="ic--round-play-arrow" viewBox="0 0 24 24"><path fill="black" d="M8 6.82v10.36c0 .79.87 1.27 1.54.84l8.14-5.18a1 1 0 0 0 0-1.69L9.54 5.98A.998.998 0 0 0 8 6.82"/></symbol>{work}</p>
        <p className="  w-full text-justify md:text-sm"><symbol id="ic--round-play-arrow" viewBox="0 0 24 24"><path fill="black" d="M8 6.82v10.36c0 .79.87 1.27 1.54.84l8.14-5.18a1 1 0 0 0 0-1.69L9.54 5.98A.998.998 0 0 0 8 6.82"/></symbol>{work1}</p>
        <p className="  w-full text-justify md:text-sm"><symbol id="ic--round-play-arrow" viewBox="0 0 24 24"><path fill="black" d="M8 6.82v10.36c0 .79.87 1.27 1.54.84l8.14-5.18a1 1 0 0 0 0-1.69L9.54 5.98A.998.998 0 0 0 8 6.82"/></symbol>{work2}</p>
        <p className="  w-full text-justify md:text-sm"><symbol id="ic--round-play-arrow" viewBox="0 0 24 24"><path fill="black" d="M8 6.82v10.36c0 .79.87 1.27 1.54.84l8.14-5.18a1 1 0 0 0 0-1.69L9.54 5.98A.998.998 0 0 0 8 6.82"/></symbol>{work3}</p>
        <p className="  w-full text-justify md:text-sm">{work4}</p>
        <p className="  w-full text-justify md:text-sm">{work5}</p>
        <p className="  w-full text-justify md:text-sm">{work6}</p>
        <p className="  w-full text-justify md:text-sm">{work7}</p>
        <p className="  w-full text-justify md:text-sm">{work8}</p>
      </motion.div>
    </li>
  );
};
